...
window.submitWithdrawal = async function() {
    ...
    if(isNaN(amt) || amt < minWithdrawLimit) { 
        alert(`Minimum withdrawal is ₹${minWithdrawLimit}`); 
        return; 
    }
    if(!upi) { 
    ...
    try {
        ...
        document.getElementById('success-msg').innerText = "Withdrawal request submitted successfully! Pending verification."; 
        showSuccessPopup(); 
        fireCanvasConfetti();
